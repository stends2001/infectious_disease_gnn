...
class ShallowDataLoaderManager:
    ...
    def construct_dataloaders(self):
        ...
        """
        main_data           = self.dataorchestrator.data_final.data
        ...
        for hh in range(self.dataorchestrator.config.horizon_size):
            ...
            y_col_selection = [f'{self.column_registration.get_by_type("target")[0]}_ahead{steps_ahead}']
            ...
            main            = main.rename(columns = {y_col_selection[0]:'target'}).dropna()
