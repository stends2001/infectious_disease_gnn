...
class IssueReport(Exception):
    """
    Aggregates multiple IssueBase instances into a single, user-friendly report.
    """
    def __init__(self, exceptions: list['IssueBase'], context: str):
    ...
    def __str__(self) -> str:
        ...
        for exc_type, exc_list in self._exceptions_dict.items():
            ...
            for idx, exc in enumerate(exc_list):
                error_messages.append(f"   [{idx+1}] {exc.message}")
